...
from ShopZee_App.views import CategoryViewSet, CustomerViewSet, LedgerViewSet, NotificationViewSet, OrderItemViewSet, OrderViewSet, PaymentViewSet, ProductViewSet, RouteViewSet, UserViewSet, VisitViewSet
